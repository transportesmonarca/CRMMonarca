-- ====================================
-- FUNCIÓN SIMPLE: crear_embarque_normalizado
-- ====================================
-- Versión simplificada que funciona con los campos básicos
...
BEGIN
    ...
    -- Obtener info del tipo de servicio
    ...
    INSERT INTO embarques_financiero (
        ...
        precio_operador, precio_operador,  -- Se copia el precio
